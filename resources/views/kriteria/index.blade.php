                ...
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                  <div class="inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="overflow-hidden w-full">
                            <form action="{{route('kriteria.store')}}" method="POST" enctype="multipart/form-data" class="bg-white rounded mx-auto flex flex-col h-full">
                                @csrf
                ...
                <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                  <div class="inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="overflow-hidden">
                      <table class="min-w-full text-left text-sm font-light bg-white rounded-xl">
                          ...
                          <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                            ...
                            <td class="whitespace-nowrap px-6 py-4 flex">
                                <div class="flex space-x-1">
                                    <!-- Modal toggle -->
                                    <button data-modal-target="edit-modal-{{$kri->id}}" data-modal-toggle="edit-modal-{{$kri->id}}" class="btn btn-edit border-2 border-[#FFF785]  hover:bg-[#FFF785] inline-block focus:ring-4 focus:outline-none focus:ring-[#FFF785]" type="button">
                                    ...
                                    <!-- Main modal -->
                                    <div id="edit-modal-{{$kri->id}}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full ">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                                                        Edit {{$kri->name_kriteria}}
                                                    </h3>
                                                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="edit-modal-{{$kri->id}}">
                                                ...
                                                <!-- Modal body -->
                                                <form action="{{ route('kriteria.update', $kri->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded px-8 flex flex-col h-full">
                                                    @method('PUT')
                                                    @csrf
                                                    <div class="grid gap-4 mb-4 grid-cols-2 p-4">
                                                        <div class="col-span-2">
                                                            ...
                                                            <input type="text" name="name_kriteria" id="name_kriteria" class="peer h-10 rounded-md border-blue-gray-200 -t-transparent font-sans text-sm font-normal w-full bg-gray-200 text-gray-700 border  py-3 px-4 mb-3 focus:ring-gray-200 focus:bg-white" placeholder="" aria-describedby="name_kriteria" value="{{$kri->name_kriteria}}">
                                                        </div>
                                                        <div class="col-span-2">
                                                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Atribut Kriteria</label>
                                                            <select name="attribute" id="attribute" class="peer h-10 rounded-md border-blue-gray-200 -t-transparent font-sans text-sm font-normal w-full bg-gray-200 text-gray-700 border px-4 mb-3 focus:ring-gray-200 focus:bg-white" aria-label="Default select example text-xs" value="{{$kri->attribute}}">
                                                                <option value="benefit" selected>Benefit</option>
                                                                <option value="cost">Cost</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-span-2">
                                                            <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Bobot Kriteria</label>
                                                            <input type="text" name="bobot" id="bobot" class="peer h-10 rounded-md border-blue-gray-200 -t-transparent font-sans text-sm font-normal w-full bg-gray-200 text-gray-700 border  py-3 px-4 mb-3 focus:ring-gray-200 focus:bg-white" aria-label="Default select example" placeholder="" aria-describedby="bobot" value="{{$kri->bobot}}">
                                                        </div>
                                                        <div class="col-span-2">
                                                            <button type="submit" class="bg-[#FFF785] block capitalize tracking-wide text-gray-700 text-xs font-bold mb-2 mx-auto p-2 w-72 focus:ring-4 focus:outline-none focus:ring-[#FFF785] rounded-lg">Simpan</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
